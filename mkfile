...
LDFLAGS=-lX11
MOD=win draw prof ntime panic io image alloc math color poly la
SRC=${MOD:%=%.c}
OBJ=${MOD:%=%.o}
PROGNAMES=split paint io bezier triangle circle line ppm sin y4m nbody poly ttf dragon 3d
